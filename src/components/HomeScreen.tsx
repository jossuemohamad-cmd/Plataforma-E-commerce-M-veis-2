  ...
  return (
    <div className="flex flex-col w-full">
      {/* ==========================================
          ...
          ========================================== */}
      <section className="home-hero eden-dark-surface relative w-full min-h-[100svh] sm:min-h-[660px] lg:h-screen flex items-end pb-24 sm:pb-16 pt-[104px] sm:pt-[116px] overflow-hidden bg-[#132240] text-white">
